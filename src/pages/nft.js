        ...
        <div className="md:flex md:space-x-[50px] mt-[-50px]">
          ...
          <div className="basis-1/2 mt-[50px]">
            <div className="modal-wrapper">
              ...
              <CountDown />
              <DaoIconButton className="2xl:w-[370px] md:w-[310px] 2xl:h-[60px] sm:h-[40px] h-[40px]">
              ...
              <DaoIconButton className="2xl:w-[370px] md:w-[310px] lg:mt-[20px] mt-[10px] 2xl:h-[60px] sm:h-[40px] h-[40px]">
